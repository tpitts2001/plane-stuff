...
def get_airlines_by_country(api_key, country):
    ...
    if response.status_code == 200:
        airlines = response.json()['historical-data']
...
def write_airlines_to_csv(airlines, filename):
    ...
    # Open the file and write the historical-data
    with open(filename, 'w', newline='', encoding='utf-8') as file:
        ...
        # Write the airline historical-data
...
write_airlines_to_csv(usa_airlines, '../../historical-data/airline_identifiers/usa_airlines.csv')