...
# Example usage
parent_folder = 'SEC income historical-data/RAW' # Replace with the path to the folder containing subfolders
output_parent_folder = 'SEC income historical-data/filtered' # Replace with the path to the parent folder for output
