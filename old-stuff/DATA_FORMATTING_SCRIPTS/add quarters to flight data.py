...
input_folder_path = 'historical-data/flight_data/filtered for model/without'
output_folder_path = 'historical-data/flight_data/filtered for model/with quarter identification'
