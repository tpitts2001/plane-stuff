...
# Usage
source_dir = 'historical-data/flight_data/RAW ASC/international'  # Replace with the path to your .asc files
target_dir = 'historical-data/flight_data/CSV/international'  # Replace with the path where you want to save .csv files
