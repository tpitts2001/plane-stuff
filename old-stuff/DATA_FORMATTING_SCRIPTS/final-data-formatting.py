...
output_csv_path = '../../historical-data/FINAL/temp/path_to_your_output_csv'  # Update this with your desired output CSV file path
oil_price_csv_path = '../../historical-data/crude_oil_data/rolled_into_quarter_avg/quarterly_oil_prices.csv'  # The CSV with Price, Year, Quarter
...
# Write the historical-data to a new CSV file
