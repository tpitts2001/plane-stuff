...
data = {
    ...
    "Description": [
        ...
        "Airports Support table", "WAC Support table historical-data that is linked","airport support table","airport code, exists in airports support file","airports support code","wac support table historical-data that is linked with airports","airports support table","this code matches up with whats in cardecodes for the carrier",
...
csv_file_path = '../../historical-data/airline_identifiers/legend-tabl-int-seg.csv'
