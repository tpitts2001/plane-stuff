...
input_csv_path = 'data/flight_data/CSV/whole/domestic.csv'  # Update this with the actual path
output_folder_path = 'data/flight_data/CSV/whole/filtered to traded companies'  # Update this with the desired output folder path
